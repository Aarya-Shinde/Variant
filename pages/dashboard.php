...
if ($user) {
    $username = htmlspecialchars($user['username']); // Use username from the database
} else {
    $username = "User"; // Fallback username if no record is found
}
?>
...
<body>
    ...
    <nav class="navbar navbar-expand-sm navbar-light">
        <div class="container">
            <a class="navbar-brand text-white" href="#" style="font-weight: bold;">Dashboard</a>
